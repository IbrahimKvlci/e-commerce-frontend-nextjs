            ...
            <div className="max-w-7xl mx-auto px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <h3 className="font-extrabold text-2xl text-white">E-Shop</h3>
                    ...
                    <div className="max-w-md mx-auto text-center">
                        ...
                        <div className="flex">
                            <input
                                ...
                                className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l focus:outline-none focus:border-blue-500 text-white"
                            />
                            <button className="bg-blue-600 text-white px-6 py-2 rounded-r hover:bg-blue-700 transition-colors font-medium">
                                Subscribe
                            </button>
                        </div>
                    </div>
