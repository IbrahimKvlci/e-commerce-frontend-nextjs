...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  return (
    ...
    <div className="p-4 flex flex-col flex-1 w-full">
        ...
        {/* Product Name */}
        <a href={`/product/${product.id}`} className="hover:text-blue-600 transition-colors text-left block w-full">
            <h3 className="font-semibold text-base mb-2 text-gray-800 group-hover:text-blue-600 break-all leading-tight w-full min-w-0 line-clamp-2">
                {product.name}aaaaaaaaasa a aaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaaaaa
            </h3>
            </a>
